...
setup(
    ...
    version=boo.__version__,

    description='A Python package to compute bond orientational order parameters',
    ...
    keywords='structure crystallography glass',
    ...
    install_requires=['numpy', 'scipy >= 0.18', 'numba'],
